    ...
    return (
        <AuthenticatedLayout categories={categories}>
            ...
            <div className="max-w-7xl mx-auto">
                ...
                {/* ログテーブル */}
                <div className="bg-[#25282c] rounded-2xl shadow-xl border border-gray-700 overflow-hidden">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-[#1a1c20] text-gray-400 text-xs uppercase tracking-wider ">
                                <th className="px-6 py-4 font-bold">日時</th>
                                <th className="px-6 py-4 font-bold">担当者</th>
                                <th className="px-6 py-4 font-bold">商品</th>
                                <th className="px-6 py-4 font-bold">変動数</th>
                                <th className="px-6 py-4 font-bold">理由</th>
                            </tr>
                        </thead>
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex flex-col">
                                            <span className="text-sm text-white font-bold">{log.product?.name}</span>
                                            <span className="text-xs text-gray-500">{log.product?.sku}</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                        <span className={`text-sm font-bold ${log.quantity > 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
